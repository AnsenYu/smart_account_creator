...
setup:
	$(CLEOS) system newaccount --stake-net "1.0000 ENU" --stake-cpu "1.0000 ENU" --buy-ram-kbytes 8000 eosio $(CONTRACT_ACCOUNT) $(PK) $(PK)
	...
	$(CLEOS) system newaccount --stake-net "1.0000 ENU" --stake-cpu "1.0000 ENU" --buy-ram-kbytes 8000 eosio saccountfees $(PK) $(PK)

test:
	$(CLEOS) transfer angelo $(CONTRACT_ACCOUNT) "1.0000 ENU" "$(ACCOUNT_NAME):ENU7R6HoUvevAtoLqUMSix74x9Wk4ig75tA538HaGXLFKpquKCPkH:ENU6bWFTECWtssKrHQVrkKKf68EydHNyr1ujv23KCZMFUxqwcGqC3" -p $(CONTRACT_ACCOUNT)@active -p angelo@active
